            ...
            try
            {
                ...
                using (SqlConnection nuevaConexion = Conexion.conexion())
                {
                    ...
                    while (Lector.Read())
                    {
                        ...
                        sl.SetCellValue("AM" + celdaContenido, Double.Parse(Lector["FACTURA SIN IVA"].ToString()));
                        sl.SetCellValue("AN" + celdaContenido, Double.Parse(Lector["FACTURA NETO"].ToString()));
                        ...
                        sl.SetCellValue("AQ" + celdaContenido, Double.Parse(Lector["COSTO ADQUISICION"].ToString()));
                        sl.SetCellValue("AR" + celdaContenido, Double.Parse(Lector["UTILIDAD ADQUISICION"].ToString()));
                        sl.SetCellValue("AS" + celdaContenido, Double.Parse(Lector["COSTO OPERATIVO"].ToString()));
                        sl.SetCellValue("AT" + celdaContenido, Double.Parse(Lector["GASTO"].ToString()));
                        sl.SetCellValue("AU" + celdaContenido, Double.Parse(Lector["UTILIDAD FINAL"].ToString()));
